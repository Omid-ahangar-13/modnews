...
<div class="container">
    <div class="col-xs-33 col-ms-36 col-sm-23"><h3>آب وهوا</h3>
        ...
        {*<section>
            <div class="weather_container col-xs-36 col-sm-30 col-md-24 col-lg-24 col-lg-pull-6 col-md-pull-6 col-sm-pull-2">
                <div class="weather_header">وضعيت آب و هواي شهر<span class="weather_current_city">تهران</span><span class="weather_updated_time" dir="ltr">(۰۳:۳۰ pm)</span>
                </div>
                <div class="weather_body">
                <div class="weather_r_sec col-xs-17">
                    <div class="weather_list">
                        <span class="weather_dt">آخرين بروز رساني:</span><span class="weather_dd" dir="ltr">۱۳۹۹/۰۸/۱۶</span>
                    </div>
                    <div class="weather_list">
                        <span class="weather-list-child">وضعيت:</span><span class="weather-list-child1">تمام ابري</span>
                    </div>
                    <div class="weather_list">
                        <span class="weather-list-child">سرعت باد:</span><span class="weather-list-child1" dir="ltr">۸ km/h</span>
                    </div>
                    <div class="weather_list">
                        <span class="weather-list-child">رطوبت:</span><span class="weather-list-child1" dir="ltr">۳۰%</span>
                    </div>
                    <div class="weather_list">
                        <span class="weather-list-child">طلوع آفتاب:</span><span class="weather-list-child1" dir="ltr">۱۹:۳۴ am</span>
                    </div>
                    <div class="weather_list">
                        <span class="weather-list-child">غروب آفتاب:</span><span class="weather-list-child1" dir="ltr">۱۵:۰۲ pm</span>
                    </div>
                </div>
                <div class="weather-tmp col-xs-19">۲۱°</div>
                <img src="/media/001.JPG" alt="" class="col-xs-19">
                <div class="weather-info col-xs-19">كمينه: <span class="weather-info-title1" dir="ltr">۱۱°</span>بیشینه: <span class="weather_info-title2" dir="ltr ">۲۳°</span>
                </div>
                <div class="weather-Tomorrow col-xs-18">
                    <h3 class="weather-Tomorrow-title">فردا</h3>
                    <div class="weather-list">
                        <span class="weather-">وضعيت:</span><span class="weather-l-title">تمام ابري</span>
                    </div>
                    <div class="weather-list">
                        <span class="weather_dt">كمينه:</span><span class="weather-l-title" dir="ltr">۱۱°</span>
                    </div>
                    <div class="weather-list">
                        <span class="weather_dt">بیشینه:</span><span class="weather-l-title" dir="ltr">۲۲°</span>
                    </div>
                </div>
            </div>
        </section>*}
